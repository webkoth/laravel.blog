                        ...
                        <div id="" class="widget">
                            ...
                            <div class="banner-spot clearfix">
                                <div class="banner-img">
                                    <img src="{{ asset('assets/front/upload/small_03.jpg') }}" alt="" class="img-fluid">
                                </div><!-- end banner-img -->
                            </div><!-- end banner -->
                        </div><!-- end widget -->
                    ...
                    <div class="widget">
                        ...
                        <div class="blog-list-widget">
                            <div class="list-group">
                                <a href="marketing-single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="upload/small_01.jpg{{ asset('assets/front/upload/small_01.jpg') }}" alt="" class="img-fluid float-left">
...
<!-- Core JavaScript
================================================== -->
<script src="{{ asset('assets/front/css/front.js') }}"></script>
